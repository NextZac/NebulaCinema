...
<template>
    <div class="flex flex-row w-full h-min">
        ...
        <div class="flex justify-end align-end drop-shadow-lg">
            <img class="rounded-l-[10px] w-full h-[300px] object-cover" :src="props.image" alt="Movie Poster">
        ...
        <div
            :class="['flex flex-row gap-[35px] min-h-full w-full overflow-hidden bg-brand-975 rounded-r-[10px] p-[35px]']">

            <!--Schedule info-->
            <div class="flex flex-col h-full w-full max-w-[200px] justify-between gap-[35px]">
                <p class=" text-brand-white text-main2 font-semibold" v-html="props.startingTime"></p>
            ...
            <div class="flex flex-col w-full h-full justify-between gap-[35px]">
                ...
                <!--Title and buttons-->
                <div class="flex flex-row h-full justify-between items-center gap-[35px]">
