        ...
        <div class="flex flex-col gap-[60px]">
            ...
            >
                <div class="flex flex-col gap-2 justify-center">
                    ...
                    <p class="text-body text-brand-white/50">
                        {{ __("login.desc.login") }}
                    </p>
                </div>
                ...
                <div class="flex flex-col gap-4 w-full justify-center">
                    ...
                    >
                        ...
                        <Button
                            :isSubmit="true"
                            class="font-medium flex gap-3 justify-center !w-[100%] group/btn"
                        >
                            {{ __("login.title.login") }}
                            <ArrowRight
                    ...
                    <div class="flex gap-16 justify-between">
                        <Button
                            class="font-medium flex gap-3 justify-center !w-full"
                            color="brand-900"
                        >
                            HarID
                        </Button>
